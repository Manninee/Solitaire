...
// Palauttaa vektorin korttien osoittimista
std::vector<Card *> OpenDeck::returnCards()
{
    // Tallentaa korttien osoittimet vektoriin ja poistaa kortit  avoimesta pakasta
